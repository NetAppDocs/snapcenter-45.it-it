...
. Nella pagina *Nome*, eseguire le seguenti operazioni:
+
|===
...
.. Nella sezione *Configura pianificazioni per policy selezionate*, fare clic su *image:../media/add_policy_from_resourcegroup.gif[""]* Nella colonna Configure Schedules (Configura pianificazioni) per il criterio per il quale si desidera configurare la pianificazione.
