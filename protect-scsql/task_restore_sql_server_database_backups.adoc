...
. Dalla vista *Gestisci copie*, selezionare *backup* dal sistema di storage.
...
. Nella pagina *ambito ripristino*, selezionare una delle seguenti opzioni:
+
|===
| Opzione | Descrizione 
...
|===
. Nella pagina *Recovery Scope*, selezionare una delle seguenti opzioni:
+
|===
| Opzione | Descrizione 
...
|===
. Nella pagina *Pre Ops*, attenersi alla seguente procedura:
+
...
. Nella pagina *Post Ops*, attenersi alla seguente procedura:
+
