...
+
.. Fare clic su *Configure log directory* (Configura directory registro) e nella pagina *Configure host log directory* (Configura directory registro host), fare clic su *Browse* (Sfoglia) e completare la procedura seguente:
+
