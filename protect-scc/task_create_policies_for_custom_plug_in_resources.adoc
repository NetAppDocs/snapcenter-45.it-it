...
** Nella sezione *Impostazioni di backup personalizzate*, fornire eventuali impostazioni di backup specifiche da passare al plug-in in formato key-value. È possibile fornire più valori chiave da passare al plug-in.
