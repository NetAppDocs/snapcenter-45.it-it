...
. Nella pagina *Scripts*, immettere i comandi per il pre-clone o il post-clone che devono essere eseguiti rispettivamente prima o dopo l'operazione. Immettere il comando mount per montare un file system su un host.
+
Ad esempio:
