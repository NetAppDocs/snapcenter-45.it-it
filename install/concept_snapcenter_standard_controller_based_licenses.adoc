...
. Nell'elenco *Storage Connections*, individuare la colonna Controller License (licenza controller).
+
...
+
Per informazioni sui cmdlet, vedere https://library.netapp.com/ecm/ecm_download_file/ECMLP2877143["Guida di riferimento al cmdlet del software SnapCenter"^].
